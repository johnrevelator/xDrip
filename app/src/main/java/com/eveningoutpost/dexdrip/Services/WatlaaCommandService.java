...
/**
 * Created by Alexander Klimov on 05/05/2019.
 * based on code by jamorham
 * based on code by LadyViktoria
 * <p>
 * Should support Watlaa meter
 */

@TargetApi(Build.VERSION_CODES.KITKAT)
public class WatlaaCommandService extends Service {
    ...
    private static final String TAG = WatlaaCommandService.class.getSimpleName();

    private static final UUID GLUCOSE_DATA_SERVICE = UUID.fromString("00001010-1212-EFDE-0137-875F45AC0113");
   ...
   // private static final UUID CONTEXT_CHARACTERISTIC = UUID.fromString("00002a34-0000-1000-8000-00805f9b34fb");
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                if (queue.isEmpty()) {
                    ...
                    Bluetooth_CMD.read(BATTERY_SERVICE, BATTERY_LEVEL_CHARACTERISTIC, "get device battery level");
                    Bluetooth_CMD.write(CURRENT_TIME_SERVICE, TIME_CHARACTERISTIC, TimeUtil.INSTANCE.exactTime(Calendar.getInstance()), "send time to device");
                    Bluetooth_CMD.poll_queue();
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                } else if (characteristic.getUuid().equals(BATTERY_LEVEL_CHARACTERISTIC)) {
                    UserError.Log.d(TAG, "Got battery level characteristic read data");
                    ct = new CurrentTimeRx(characteristic.getValue());
                    statusUpdate("Device time: " + ct.toNiceString());
                } else {
    ...
    public static void stop_service() {
        final Intent stop_intent = new Intent(xdrip.getAppContext(), WatlaaCommandService.class);
    ...
    public static void start_service(String connect_address) {
        ...
        final Intent start_intent = new Intent(xdrip.getAppContext(), WatlaaCommandService.class);
